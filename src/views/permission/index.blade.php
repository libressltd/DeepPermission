	...
	<div class="col-md-3">
		<div class="box box-solid">
			...
			<div class="box-body">
				...
				{!! Form::lbText("name", "", "Name", "Permission's name", null, config("lbform.CNF_REQUIRE_ANUM")) !!}
				{!! Form::lbText("code", "", "Code", "Permission's code", "For developer only", config("lbform.CNF_REQUIRE_ANUM")) !!}
